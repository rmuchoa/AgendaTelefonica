...
\section{XML}
		...
		Para utilizar Web services, os dados podem ser criados no XML ou convertidos para o formato XML através de um ou mais formatos nativos existentes, como o ASCII ou o tipo de sistema utilizado pelo JAVA. Para um exemplo simples, imagine que...  
