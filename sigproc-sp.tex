...
\lstset{ 
	...
	No cliente, foi desenvolvida uma aplicação utilizando \emph{PhoneGap} e \emph{JQuery Mobile}. O PhoneGap permite o desenvolvimento de aplicações móveis para iOS, Android, Blackberry, Windows Phone, Palm WebOS, Bada and Symbian utilizando simplesmente: HTML, CSS and Javascript\cite{PHONEGAPSITE}.
	
	\cite{JQUERYMOBILESITE}
