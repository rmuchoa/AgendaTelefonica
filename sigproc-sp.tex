...
\begin{figure}[h]
			\begin{center}
				 \includegraphics[width=200px]{HOME DA IAMAGEM}
...
\lstset{ 
	...
	Para a criação de um web service, utilizamos a classe Zend\_Soap\_Server que fornece toda funcionalidade de um web service no protocolo SOAP,
