...
\section{Webservices}
		Web Services oferece uma camada de abstração acima dos sistemas existentes, assim como Servidores de Aplicação, 
		CORBA, servidores .Net, aplicativos mensageiros e pacotes de aplicação. Web Services trabalha sobre 
		uma camada de abistração similar a da Internet e são compativeis de realizar a transição entre qualquer sistema operacional, 
...
Os Web Services utilizam esquemas em XML para a validação de mensagens. O SOAP do computador que esta enviando a mensagem transforma seus dados da forma nativa para o esquema XML pré-definido contido no arquivo WDSL para texto, pontos flutuantes, e outros, usando o mapeamento das tabelas.
